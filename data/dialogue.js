...
const OARS_EXPLANATION = {
  ...
  affirm:
    "This is an AFFIRMATION: \n\nMI relies on clients’ own personal strengths, efforts, and resources. It is the client, not the counselor who produces change. \n\nAffirmation is both general and specific in MI. The counselor in general respects and honors the client as a person of worth, with the capability for growth and change as well as volitional choice about whether to do so. The interviewer also recognizes and comments on the client’s particular strengths, abilities, good intentions, and efforts. \n\nAffirmation is also a way of thinking: the clinician consciously is on the lookout for client strengths, good steps, and intentions. This mind-set of “accentuate the positive” is a discipline in itself.",
  reflect:
    "This is a REFLECTION:\n\nReflective statements that make a guess about the client’s meaning have the important function of deepening understanding by clarifying whether one’s guess is accurate. \n\nReflective statements also allow people to hear again the thoughts and feelings they are expressing, perhaps in different words, and ponder them. \n\nGood reflective listening tends to keep the person talking, exploring, and considering. \n\nIt is also necessarily selective, in that one chooses which aspects to reflect from all that the person has said.",
  summarize:
    "This is a SUMMARY:\n\nSummaries are essentially reflections that collect what a person has been saying, offering it back as in a basket.\n\nThey can be used to pull together what has been said, as at the end of a session. They may suggest links between present material and what has been discussed before.\n\nSummaries can also function as a transition from one task to another.\n\nIn the engaging and focusing processes of MI, summaries promote understanding and show clients that you have been listening carefully, remembering and valuing what they say. They also provide a “What else?” opportunity for the person to fill in what you have missed.\n\nIn evoking, there are particular guidelines for what to include in a summary in order to collect change talk and move along the process of change. During planning, summaries draw together the person’s motivations, intentions, and specific plans for change",
  notOars: "Not OARS",
};
